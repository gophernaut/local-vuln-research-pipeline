...
ALL_SINKS = {
    "python": [
        ...
        (r"\bET\.fromstring\s*\(", "xxe", "CWE-611", "ElementTree XML parsing (XXE risk)"),
        (r"\bET\.parse\s*\(", "xxe", "CWE-611", "ElementTree XML parsing (XXE risk)"),
        (r"\bxml\.dom\.minidom\.parseString\s*\(", "xxe", "CWE-611", "minidom XML parsing (XXE risk)"),
        (r"\blxml\.etree\.fromstring\s*\(", "xxe", "CWE-611", "lxml XML parsing (XXE risk)"),
        ...
        (r"app\.debug\s*=\s*True", "security_misconfig", "CWE-489", "Flask debug mode enabled (production risk)"),
        (r"DEBUG\s*=\s*True", "security_misconfig", "CWE-489", "Debug flag set to True"),
        (r"app\.run\s*\([^)]*debug\s*=\s*True", "security_misconfig", "CWE-489", "Flask app.run with debug=True"),
        (r"\.run\s*\([^)]*debug\s*=\s*True", "security_misconfig", "CWE-489", "Flask app.run with debug=True"),
